...
<form action="<?php echo $editFormAction; ?>" name="notation" method="POST" class="form-horizontal" id="notation">
  ...
  <div class="modal-body">
    ...
    <ul class="listes">
      ...
      <li class="row-fluid">
        <div class="span9">
          <p><strong>3-</strong> Y a-t-il, selon vous, assez d'aménagements entre la ville et son pays adoptif permettant leur lien&nbsp;? (exemple : réseaux de transports, tracés des routes etc.)</p>
        </div>
      ...
      <li class="row-fluid">
        <div class="span9">
          <p><strong>4-</strong> Trouvez-vous cohérent le chiffre indiqué pour la population de la ville&nbsp;?</p>
        </div>
