...
mysql_select_db($database_maconnexion, $maconnexion);
$query_ZonesPays = "SELECT ch_geo_id, ch_geo_wkt, ch_geo_pay_id, ch_geo_type, ch_geo_nom FROM geometries LEFT JOIN pays ON ch_geo_pay_id = ch_pay_id WHERE (ch_pay_publication = 1 OR ch_geo_pay_id = 1) AND ch_geo_geometries = 'polygon' AND ch_geo_type= 'region'";
