...
$x=$row_MarkerVilles['ch_vil_coord_X'];
$y=$row_MarkerVilles['ch_vil_coord_Y'];
$PaysID = $row_MarkerVilles ['ch_vil_paysID'];
...
<?php } ?>			
  ...
  // calque vector villes
            ...
            map.addLayers([vectors2, vectors3]);			
...
$Specialiteville = str_replace ( '-', ' ', $row_MarkerVilles['ch_vil_specialite']);
		...
		<?php if ($row_MarkerVilles['ch_vil_population'] < 50000) {?>
		var sizeicon = 6;
        <?php } elseif ($row_MarkerVilles['ch_vil_population'] <= 100000) { ?>
		var sizeicon = 7;
		<?php } elseif ($row_MarkerVilles['ch_vil_population'] <= 250000) { ?>
		var sizeicon = 8;
		<?php } elseif ($row_MarkerVilles['ch_vil_population'] <= 500000) { ?>
		var sizeicon = 9;
		<?php } elseif ($row_MarkerVilles['ch_vil_population'] <= 1000000) { ?>
		var sizeicon = 10;
		<?php } elseif ($row_MarkerVilles['ch_vil_population'] <= 2500000) { ?>
		var sizeicon = 11;
		<?php } elseif ($row_MarkerVilles['ch_vil_population'] <= 5000000) { ?>
		var sizeicon = 12;
		...
		<?php } while ($row_MarkerMonument = mysql_fetch_assoc($MarkerMonument)); ?>
		  ...
		  // Evennement a la selection. 
			...
			// ajout regles de selection
                ...
                [vectorsZones, vectorsVoies, vectors3 ]
            );
