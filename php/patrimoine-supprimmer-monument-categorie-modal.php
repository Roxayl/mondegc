...
<h3 id="myModalLabel">Enlever <?php echo $row_mon['ch_pat_nom']; ?> de la cat&eacute;gorie <?php echo $row_mon['ch_mon_cat_nom']; ?> </h3>
          ...
          <div class="span9">
          <h1>Attention&nbsp;!</h1>
    <p>Souhaitez-vous r&eacute;ellement enlever <?php echo $row_mon['ch_pat_nom']; ?> de cette cat&eacute;gorie&nbsp;?</p>
    ...
    <div class="span3 icone-categorie"> 
          <img src="<?php echo $row_mon['ch_mon_cat_icon']; ?>" alt="icone cat&eacute;gorie" style="background-color:<?php echo $row_mon['ch_mon_cat_couleur']; ?>;">
...
<form action="disp_monument_supprimer.php" name="supprimer-categorie" method="POST" id="supprimer-categorie">
            <input name="ch_disp_id" type="hidden" value="<?php echo $row_mon['ch_disp_id']; ?>">
            <input name="ch_disp_cat_id" type="hidden" value="<?php echo $row_mon['ch_disp_cat_id']; ?>">
