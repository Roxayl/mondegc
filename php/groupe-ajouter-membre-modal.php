...
do { 
$mail = $row_list_admin['ch_use_mail'];// D�claration de l'adresse de destination.
$nomGroupe = $row_groupe['ch_mem_group_nom']; // D�claration du nom du groupe.
$GroupeID = $row_groupe['ch_mem_group_ID']; // D�claration id du groupe.
...
$message_txt = "Cher membre de G&eacute;n&eacute;ration City. Un membre a souhait&eacute; rejoindre le groupe $nomGroupe. En tant qu'administrateur, il vous appartient d'accepter ou non son int&eacute;gration. Pour cela, cliquez sur le lien ci-dessous : http://www.generation-city.com/monde/back/membre-modifier_back.php?mem_groupID=$GroupeID#classer-membres. Pour accepter sa demande, vous devez lui attribuer un statut en cliquant sur le bouton �diter. Pour la refuser, il vous suffit de supprimer le membre de ce groupe. Nous vous remercions de l'inter&ecirc;t que vous portez &agrave; notre monde. l'&eacute;quipe de G&eacute;n&eacute;ration City";
...
<a href='http://www.generation-city.com/monde/back/membre-modifier_back.php?mem_groupID=$GroupeID#classer-membres'>http://www.generation-city.com/monde/back/membre-modifier_back.php?mem_groupID=$GroupeID#classer-membres</a><br><br>Pour accepter sa demande, vous devez lui attribuer un statut en cliquant sur le bouton �diter.<br>Pour la refuser, il vous suffit de supprimer le membre de ce groupe.<br>Nous vous remercions de l'inter&ecirc;t que vous portez &agrave; notre monde.<br><br><br><em><i>L'&eacute;quipe de G&eacute;n&eacute;ration City</i></em></body></html>";
//==========
