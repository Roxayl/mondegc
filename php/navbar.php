  ...
  <div class="navbar-inner">
    <div class="container"> 
      ...
      <div class="visible-tablet navbar-form menu-gestion menu-gestion-front <?php echo $_SESSION['menu_gestion']?>"><span class="Nav-pseudo">Bienvenue <?php echo $_SESSION['login_user']?>&nbsp;</span>
        <form  action="back/page_pays_back.php" method="post">
          <input name="pays_ID" type="hidden" value="<?php echo $_SESSION['pays_ID']; ?>">
        ...
        <form action="back/membre-modifier_back.php" method="post">
          <input name="pays_ID" type="hidden" value="<?php echo $_SESSION['pays_ID']; ?>">
          <input name="userID" type="hidden" value="<?php echo $_SESSION['user_ID']; ?>">
