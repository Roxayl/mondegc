                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'url'">{{ trans('admin.page.columns.url') }}</th>
                                    <th is='sortable' :column="'seo_description'">{{ trans('admin.page.columns.seo_description') }}</th>
                                    <th is='sortable' :column="'seo_keywords'">{{ trans('admin.page.columns.seo_keywords') }}</th>
                                    <th is='sortable' class="text-center" :column="'published_at'">{{ trans('admin.page.columns.published_at') }}</th>
                                    <th is='sortable' :column="'cover_image'">{{ trans('admin.page.columns.cover_image') }}</th>
                                ...
                                <tr v-for="(item, index) in collection" :key="item.id" :class="bulkItems[item.id] ? 'bg-bulk' : ''">
                                    ...
                                    <td class="text-center text-nowrap">
                                        <span v-if="item.published_at <= now">
                                            ...
                                            <span v-if="item.published_at > now">
                                            <small>{{ trans('admin.page.actions.will_be_published') }}</small><br />
                                            @{{ item.published_at | datetime('DD.MM.YYYY, HH:mm') }}
