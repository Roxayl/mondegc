...
if ((isset($_POST['ch_inf_id'])) && ($_POST['ch_inf_id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM infrastructures WHERE ch_inf_id=%s",
                       GetSQLValueString($_POST['ch_inf_id'], "int"));

  
  $Result1 = mysql_query($deleteSQL, $maconnexion) or die(mysql_error());

  $deleteGoTo = DEF_URI_PATH . "back/ville_modifier.php";
...
<head>
<meta charset="utf-8">
<title>Haut-Conseil - Supprimer une infrastructure</title>
...
<div id="introheader" class="jumbotron">
  <div class="container">
    <h2>Suppression de l'infrastructure en cours...</h2>
  </div>
</div>
<!-- Footer
    ================================================== -->
