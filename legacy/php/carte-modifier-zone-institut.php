...
var format = new OpenLayers.Format.WKT({
    ...
    'externalProjection': new OpenLayers.Projection("EPSG:4326")
			...
			?>
var polygonFeature = format.read("<?= __s($row_VoiesPays['ch_geo_wkt']) ?>");
polygonFeature.attributes = {
				couleurTrait : "<?= __s($couleurTrait); ?>",
				epaisseurTrait : "<?= __s($epaisseurTrait); ?>",
				Trait : "<?= __s($Trait); ?>",
				formulaire : "<h2>Modifier une voie</h2><p>Cr&eacute;&eacute; par&nbsp;:&nbsp;<?= __s($row_VoiesPays['ch_use_login']); ?></p><form action='<?= __s($editFormAction); ?>' method='POST' class='' name='modifier_feature' Id='ajout_feature' onsubmit=''><input name='ch_geo_id' type='hidden' value='<?= __s($row_VoiesPays['ch_geo_id']); ?>'><input name='ch_geo_bounds' id='ch_geo_bounds' type='hidden' value=''><input name='ch_geo_pay_id' type='hidden' value='<?= __s($row_VoiesPays['ch_geo_pay_id']); ?>'><input name='ch_geo_user' type='hidden' value='<?= __s($row_VoiesPays['ch_geo_user']); ?>'><input name='ch_geo_maj_user' type='hidden' value='<?= __s($_SESSION['user_ID']); ?>'><input name='ch_geo_date' type='hidden' value='<?= __s($row_VoiesPays['ch_geo_date']) ?>'><input name='ch_geo_mis_jour' type='hidden' value='<?= __s($now) ?>'><input name='ch_geo_geometries' type='hidden' value='line'><div><h4>Type de voie</h4><select id='ch_geo_type' name='ch_geo_type' class='span12'><option value='lgv' <?php if (!(strcmp("lgv", $row_VoiesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Ligne &agrave; Grande Vitesse</option><option value='cheminFer' <?php if (!(strcmp("cheminFer", $row_VoiesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Chemin de fer</option><option value='canal' <?php if (!(strcmp("canal", $row_VoiesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Canal</option><option value='ferry' <?php if (!(strcmp("ferry", $row_VoiesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Ferry</option><option value='maritime' <?php if (!(strcmp("maritime", $row_VoiesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Route maritime</option><option value='autoroute' <?php if (!(strcmp("autoroute", $row_VoiesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Autoroutes</option><option value='voieexpress' <?php if (!(strcmp("voieexpress", $row_VoiesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Voie express</option><option value='nationale' <?php if (!(strcmp("nationale", $row_VoiesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Route nationale</option><option value='frontiere' <?php if (!(strcmp("frontiere", $row_VoiesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Frontière</option></select></div><div><h4>Nom de votre voie</h4><input class='span12' type='text' id='ch_geo_nom' name='ch_geo_nom' value='<?= __s($row_VoiesPays['ch_geo_nom']) ?>'></div><div><h4>Longueur (km)</h4><input class='span12' type='text' id='ch_geo_mesure' name='ch_geo_mesure' value='<?= __s($row_VoiesPays['ch_geo_mesure']) ?>' readonly = 'readonly'></div><div><h4>Geometrie</h4><textarea class='span12' id='ch_geo_wkt' name='ch_geo_wkt' rows='6' readonly = 'readonly'></textarea></div><a class='btn btn-danger pull-right' href='carte_geometrie_supprimer.php?ch_geo_id=<?= __s($row_VoiesPays['ch_geo_id']) ?>&is_back=true' title='supprimer cette zone' style='text-decoration:none;'>supprimer</a><button type='submit' class='btn btn-primary'>Enregistrer</button><input type='hidden' name='MM_update' value='modifier_feature'></form>"
            } 
...
// calque vector Monuments
            ...
            map.addLayers([vectors1, vectors2, vectors3]);		
	            ...
	            map.addControl(new OpenLayers.Control.KeyboardDefaults());
	       		map.setCenter(new OpenLayers.LonLat(<?= __s($bounds) ?>), 2);
...
function ajouterVoie(feature) {
            ...
            var bounds = feature.geometry.getBounds().getCenterLonLat();
			bounds= bounds.toShortString();
			var formulaire = "<h2>Ajouter une voie</h2><form action='<?= __s($editFormAction) ?>' method='POST' class='' name='ajout_feature' Id='ajout_feature' onsubmit=''><input name='ch_geo_bounds' id='ch_geo_bounds' type='hidden' value=''><input name='ch_geo_pay_id' type='hidden' value='1'><input name='ch_geo_user' type='hidden' value='<?= __s($_SESSION['user_ID']) ?>'><input name='ch_geo_maj_user' type='hidden' value='<?= __s($_SESSION['user_ID']) ?>'><input name='ch_geo_date' type='hidden' value='<?= __s($now) ?>'><input name='ch_geo_mis_jour' type='hidden' value='<?= __s($now) ?>'><input name='ch_geo_geometries' type='hidden' value='line'><div><h4>Type de voie</h4><select id='ch_geo_type' name='ch_geo_type' class='span12'><option value='lgv'>Ligne &agrave; grande vitesse</option><option value='cheminFer'>Chemin de fer</option><option value='canal'>Canal</option><option value='ferry'>Ferry</option><option value='maritime'>Route maritime</option><option value='autoroute'>Autoroute</option><option value='voieexpress'>Voie express</option><option value='nationale'>Route nationale</option><option value='frontiere'>Frontière</option></select></div><div><h4>Nom de votre voie</h4><input class='span12' type='text' id='ch_geo_nom' name='ch_geo_nom' value=''></div><div><h4>Longueur (km)</h4><input class='span12' type='text' id='ch_geo_mesure' name='ch_geo_mesure' value='' readonly = 'readonly'></div><div><h4>Geometrie</h4><textarea class='span12' id='ch_geo_wkt' name='ch_geo_wkt' rows='6' readonly = 'readonly'></textarea></div><center><button type='submit' class='btn btn-primary'>Enregistrer</button></center><input type='hidden' name='MM_insert' value='ajout_feature'></form>";
			document.getElementById("info").innerHTML = formulaire;
			document.getElementById("ch_geo_wkt").innerHTML = out;
