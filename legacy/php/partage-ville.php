...
$query_villes = sprintf("SELECT ch_vil_ID, ch_vil_nom, ch_vil_lien_img1, ch_vil_user, ch_vil_paysID, ch_pay_lien_forum, ch_use_id FROM villes INNER JOIN pays ON ch_vil_paysID = ch_pay_id LEFT JOIN  users ON ch_use_paysID = ch_vil_paysID WHERE ch_vil_ID = %s AND ch_vil_capitale<>3", escape_sql($ville_ID, "int"));
...
<div class="modal-header">
  ...
  <h3 id="myModalLabel">Partager <strong> <?= e($row_villes['ch_vil_nom']) ?></strong> sur le forum de G&eacute;n&eacute;ration City</h3>
</div>
    ...
    <div class="span8">
      <div class="well">
        ...
        <div class="pull-center"><img src="http://monde.generation-city.com/assets/img/IconesBDD/100/Ville1.png">
          <h4><?= e($row_villes['ch_vil_nom']) ?> a &eacute;t&eacute; mise &agrave; jour</h4>
        </div>
...
<div class="modal-body corps-page"> 
  ...
  <form action="<?= e($editFormAction) ?>" method="POST" class="form-horizontal well" name="ajout_lien" Id="ajout_lien">
    ...
    <?php } ?>
    <!-- Lien Forum -->
    <input type="hidden" id="ch_pay_id" name="ch_pay_id" value="<?= e($row_villes['ch_vil_paysID']) ?>">
