...
$query_MarkerPays = sprintf("SELECT ch_pay_id, ch_pay_continent, ch_pay_emplacement, ch_pay_nom, ch_pay_lien_imgheader, ch_pay_lien_imgdrapeau, ch_pay_mis_jour, ch_use_lien_imgpersonnage, ch_use_login, Sum(villes.ch_vil_population) AS ch_pay_population, Count(villes.ch_vil_ID) AS ch_pay_nbvilles FROM pays LEFT JOIN villes ON ch_pay_id = ch_vil_paysID AND ch_vil_capitale != 3 LEFT JOIN users ON pays.ch_pay_id = users.ch_use_paysID WHERE ch_pay_id=%s AND ch_pay_publication = 1 GROUP BY ch_pay_id ORDER BY ch_pay_nom ASC", escape_sql($colname_paysID, "int"));
...
$query_MarkerVilles = sprintf ("SELECT ch_vil_nom, ch_vil_coord_X, ch_vil_coord_Y, ch_vil_capitale, ch_vil_population FROM villes INNER JOIN pays ON villes.ch_vil_paysID = pays.ch_pay_id LEFT JOIN users ON villes.ch_vil_user = users.ch_use_id WHERE ch_vil_paysID = %s AND ch_vil_capitale <> 3 AND pays.ch_pay_publication = 1 ORDER BY ch_vil_paysID ASC", escape_sql($colname_paysID, "int"));
...
$query_MarkerMonument = sprintf ("SELECT ch_pat_nom, ch_pat_coord_X, ch_pat_coord_Y, pays.ch_pay_id FROM patrimoine INNER JOIN villes ON  ch_pat_villeID=villes.ch_vil_ID INNER JOIN pays ON villes.ch_vil_paysID = pays.ch_pay_id WHERE ch_pat_statut=1 AND ch_vil_capitale <> 3 AND pays.ch_pay_publication = 1 AND pays.ch_pay_id=%s ORDER BY ch_pat_id ASC", escape_sql($colname_paysID, "int"));
...
map.addLayer(vectorLayer);
  ...
  // Ajout style element selectionnes Info
...
polygonFeature.attributes = {
				...
				opaciteTrait : "<?php echo $strokeOpacity; ?>",
				Trait : "<?php echo $Trait; ?>",
				typeZone : "<?= e($row_ZonesPays['ch_geo_type']) ?>",
				formulaire : "<h2>Modifier cette zone</h2><p>Cr&eacute;&eacute; par&nbsp;:&nbsp;<?= e($row_ZonesPays['ch_use_login']) ?></p><form action='<?= e($editFormAction) ?>' method='POST' class='' name='modifier_feature' Id='ajout_feature' onsubmit=''><input name='ch_geo_id' type='hidden' value='<?= e($row_ZonesPays['ch_geo_id']) ?>'><input name='ch_geo_bounds' id='ch_geo_bounds' type='hidden' value=''><input name='ch_geo_pay_id' type='hidden' value='<?= e($row_ZonesPays['ch_geo_pay_id']) ?>'><input name='ch_geo_user' type='hidden' value='<?= e($row_ZonesPays['ch_geo_user']) ?>'><input name='ch_geo_maj_user' type='hidden' value='<?= e($_SESSION['user_ID']) ?>'><input name='ch_geo_date' type='hidden' value='<?= e($row_ZonesPays['ch_geo_date']) ?>'><input name='ch_geo_mis_jour' type='hidden' value='<?php echo $now; ?>'><input name='ch_geo_geometries' type='hidden' value='polygon'><div><h4>Type de zone</h4><select id='ch_geo_type' name='ch_geo_type' class='span12'><optgroup label='Zones am&eacute;nag&eacute;es'><option value='urbaine' <?php if (!(strcmp("urbaine", $row_ZonesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Megapole</option><option value='megapole' <?php if (!(strcmp("megapole", $row_ZonesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Zone urbaine</option><option value='periurbaine' <?php if (!(strcmp("periurbaine", $row_ZonesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Zone p&eacute;riurbaine</option><option value='industrielle' <?php if (!(strcmp("industrielle", $row_ZonesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Zone industrielle</option><option value='maraichere' <?php if (!(strcmp("maraichere", $row_ZonesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Culture mara&icirc;ch&egrave;re</option><option value='cerealiere' <?php if (!(strcmp("cerealiere", $row_ZonesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Culture c&eacute;r&eacute;ali&egravere</option><option value='elevage' <?php if (!(strcmp("elevage", $row_ZonesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Elevage</option></optiongroup><optgroup label='Zones naturelles'><option value='peche traditionnelle' <?php if (!(strcmp("peche traditionnelle", $row_ZonesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Zone de peche traditionnelle</option><option value='peche intensive' <?php if (!(strcmp("peche intensive", $row_ZonesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Zone de peche intensive</option><option value='maritime protegee' <?php if (!(strcmp("maritime protegee", $row_ZonesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Zone maritime protegee</option><option value='prairies' <?php if (!(strcmp("prairies", $row_ZonesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Prairies</option><option value='forestiere' <?php if (!(strcmp("forestiere", $row_ZonesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Zone foresti&egrave;re</option><option value='protegee' <?php if (!(strcmp("protegee", $row_ZonesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Zone foresti&egrave;re prot&eacute;g&eacute;e</option><option value='marecageuse' <?php if (!(strcmp("marecageuse", $row_ZonesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Zone mar&eacute;cageuse</option><option value='lagunaire' <?php if (!(strcmp("lagunaire", $row_ZonesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Zone lagunaire</option></optiongroup><optgroup label='Limites administratives'><option value='region' <?php if (!(strcmp("region", $row_ZonesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>R&eacute;gion</option></optiongroup></select></div><div><h4>Nom de votre zone</h4><input class='span12' type='text' id='ch_geo_nom' name='ch_geo_nom' value='<?= e($row_ZonesPays['ch_geo_nom']) ?>'></div><div><h4>Surface (km<sup>2</sup>)</h4><input class='span12' type='text' id='ch_geo_mesure' name='ch_geo_mesure' value='<?= e($row_ZonesPays['ch_geo_mesure']) ?>' readonly = 'readonly'></div><div><h4>Geometrie</h4><textarea class='span12' id='ch_geo_wkt' name='ch_geo_wkt' rows='6' readonly = 'readonly'></textarea></div><a class='btn btn-danger pull-right' href='back/carte_geometrie_supprimer.php?ch_geo_id=<?= e($row_ZonesPays['ch_geo_id']) ?>&ch_geo_pay_id=<?= e($row_ZonesPays['ch_geo_pay_id']) ?>' title='supprimer cette zone' style='text-decoration:none;'>supprimer</a><button type='submit' class='btn btn-primary'>Enregistrer</button><input type='hidden' name='MM_update' value='modifier_feature'></form>"
            } 
...
polygonFeature.attributes = {
				...
				Trait : "<?php echo $Trait; ?>",
				typeZone : "<?= e($row_VoiesPays['ch_geo_type']) ?>",
				formulaire : "<div class'row-fluid'><h2>Modifier une voie</h2><p>Cr&eacute;&eacute; par&nbsp;:&nbsp;<?= e($row_VoiesPays['ch_use_login']) ?></p><form action='<?= e($editFormAction) ?>' method='POST' class='' name='modifier_feature' Id='ajout_feature' onsubmit=''><input name='ch_geo_id' type='hidden' value='<?= e($row_VoiesPays['ch_geo_id']) ?>'><input name='ch_geo_bounds' id='ch_geo_bounds' type='hidden' value=''><input name='ch_geo_pay_id' type='hidden' value='<?php echo $colname_paysID; ?>'><input name='ch_geo_user' type='hidden' value='<?= e($row_VoiesPays['ch_geo_user']) ?>'><input name='ch_geo_maj_user' type='hidden' value='<?= e($_SESSION['user_ID']) ?>'><input name='ch_geo_date' type='hidden' value='<?= e($row_VoiesPays['ch_geo_date']) ?>'><input name='ch_geo_mis_jour' type='hidden' value='<?php echo $now; ?>'><input name='ch_geo_geometries' type='hidden' value='line'><div><h4>Type de voie</h4><select id='ch_geo_type' name='ch_geo_type' class='span12'><option value='lgv' <?php if (!(strcmp("lgv", $row_VoiesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Ligne &agrave; Grande Vitesse</option><option value='cheminFer' <?php if (!(strcmp("cheminFer", $row_VoiesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Chemin de fer</option><option value='canal' <?php if (!(strcmp("canal", $row_VoiesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Canal</option><option value='autoroute' <?php if (!(strcmp("autoroute", $row_VoiesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Autoroutes</option><option value='voieexpress' <?php if (!(strcmp("voieexpress", $row_VoiesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Voie express</option><option value='nationale' <?php if (!(strcmp("nationale", $row_VoiesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Route nationale</option><option value='ferry' <?php if (!(strcmp("ferry", $row_VoiesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Ferry</option><option value='route maritime' <?php if (!(strcmp("route maritime", $row_ZonesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Route maritime</option><option value='frontiere' <?php if (!(strcmp("frontiere", $row_VoiesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Frontière</option></select></div><div><h4>Nom de votre voie</h4><input class='span12' type='text' id='ch_geo_nom' name='ch_geo_nom' value='<?= e($row_VoiesPays['ch_geo_nom']) ?>'></div><div><h4>Longueur (km)</h4><input class='span12' type='text' id='ch_geo_mesure' name='ch_geo_mesure' value='<?= e($row_VoiesPays['ch_geo_mesure']) ?>' readonly = 'readonly'></div><div><h4>Geometrie</h4><textarea class='span12' id='ch_geo_wkt' name='ch_geo_wkt' rows='6' readonly = 'readonly'></textarea></div><a class='btn btn-danger pull-right' href='back/carte_geometrie_supprimer.php?ch_geo_id=<?= e($row_VoiesPays['ch_geo_id']) ?>&ch_geo_pay_id=<?= e($row_VoiesPays['ch_geo_pay_id']) ?>' title='supprimer cette zone' style='text-decoration:none;'>supprimer</a><button type='submit' class='btn btn-primary'>Enregistrer</button><input type='hidden' name='MM_update' value='modifier_feature'></form></div>"
            } 
...
<?php if ($row_MarkerMonument) { ?>
  ...
  // Ajout control Info
		...
		var drawPath = new OpenLayers.Control.DrawFeature(vectorsAjoutVoie, OpenLayers.Handler.Path, {displayClass: 'lineButton', title: 'Tracer une nouvelle route', handlerOptions: {style: sty}});
		var drawPolygon = new OpenLayers.Control.DrawFeature(vectorsAjoutZone, OpenLayers.Handler.Polygon, {displayClass: 'polygonButton', title: 'Tracer une nouvelle zone', handlerOptions: {style: sty}});
...
function ajouterZone(feature) {
			...
			var formulaire = "<h2>Ajouter une zone</h2><form action='<?= e($editFormAction) ?>' method='POST' class='' name='ajout_feature' Id='ajout_feature' onsubmit=''><input name='ch_geo_bounds' id='ch_geo_bounds' type='hidden' value=''><input name='ch_geo_pay_id' type='hidden' value='<?php echo $colname_paysID; ?>'><input name='paysID' type='hidden' value='<?php echo $colname_paysID; ?>'><input name='ch_geo_user' type='hidden' value='<?= e($_SESSION['user_ID']) ?>'><input name='ch_geo_maj_user' type='hidden' value='<?= e($_SESSION['user_ID']) ?>'><input name='ch_geo_date' type='hidden' value='<?php echo $now; ?>'><input name='ch_geo_mis_jour' type='hidden' value='<?php echo $now; ?>'><input name='ch_geo_geometries' type='hidden' value='polygon'><div><h4>Type de zone</h4><select id='ch_geo_type' name='ch_geo_type' class='span12'><optgroup label='Zones am&eacute;nag&eacute;es'><option value='megapole'>Zone megapole</option><option value='urbaine'>Zone urbaine</option><option value='periurbaine'>Zone p&eacute;riurbaine</option><option value='industrielle'>Zone industrielle</option><option value='maraichere'>Culture mara&icirc;ch&egrave;re</option><option value='cerealiere'>Culture c&eacute;r&eacute;ali&egravere</option><option value='elevage'>Elevage</option></optiongroup><optgroup label='Zones naturelles'><option value='peche traditionnelle'>Zone de peche traditionnelle</option><option value='peche intensive'>Zone de peche intensive</option><option value='maritime protegee'>Zone maritime protegee</option><option value='prairies'>Prairies</option><option value='forestiere'>Zone foresti&egrave;re</option><option value='protegee'>Zone foresti&egrave;re prot&eacute;g&eacute;e</option><option value='marecageuse'>Zone mar&eacute;cageuse</option><option value='lagunaire'>Zone lagunaire</option></optiongroup></optiongroup><optgroup label='Limites administratives'><option value='region' label='limite administrative'>R&eacute;gion</option></optiongroup></select></div><div><h4>Nom de votre zone</h4><input class='span12' type='text' id='ch_geo_nom' name='ch_geo_nom' value=''></div><div><h4>Surface (km<sup>2</sup>)</h4><input class='span12' type='text' id='ch_geo_mesure' name='ch_geo_mesure' value='' readonly = 'readonly'></div><div><h4>Geometrie</h4><textarea class='span12' id='ch_geo_wkt' name='ch_geo_wkt' rows='6' readonly = 'readonly'></textarea></div><center><button type='submit' class='btn btn-primary'>Enregistrer</button></center><input type='hidden' name='MM_insert' value='ajout_feature'></form>";
...
function ajouterVoie(feature) {
            ...
            var bounds = feature.geometry.getBounds().getCenterLonLat();
			bounds= bounds.toShortString();
			var formulaire = "<h2>Ajouter une voie</h2><form action='<?= e($editFormAction) ?>' method='POST' class='' name='ajout_feature' Id='ajout_feature' onsubmit=''><input name='ch_geo_bounds' id='ch_geo_bounds' type='hidden' value=''><input name='ch_geo_pay_id' type='hidden' value='<?php echo $colname_paysID; ?>'><input name='paysID' type='hidden' value='<?php echo $colname_paysID; ?>'><input name='ch_geo_user' type='hidden' value='<?= e($_SESSION['user_ID']) ?>'><input name='ch_geo_maj_user' type='hidden' value='<?= e($_SESSION['user_ID']) ?>'><input name='ch_geo_date' type='hidden' value='<?php echo $now; ?>'><input name='ch_geo_mis_jour' type='hidden' value='<?php echo $now; ?>'><input name='ch_geo_geometries' type='hidden' value='line'><div><h4>Type de voie</h4><select id='ch_geo_type' name='ch_geo_type' class='span12'><option value='lgv'>Ligne &agrave; grande vitesse</option><option value='cheminFer'>Chemin de fer</option><option value='canal'>Canal</option><option value='autoroute'>Autoroute</option><option value='voieexpress'>Voie express</option><option value='nationale'>Route nationale</option><option value='ferry' <?php if (!(strcmp("ferry", $row_VoiesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Ferry</option><option value='route maritime' <?php if (!(strcmp("route maritime", $row_ZonesPays['ch_geo_type']))) {echo "selected=\'selected\'";} ?>>Route maritime</option></select></div><div><h4>Nom de votre voie</h4><input class='span12' type='text' id='ch_geo_nom' name='ch_geo_nom' value=''></div><div><h4>Longueur (km)</h4><input class='span12' type='text' id='ch_geo_mesure' name='ch_geo_mesure' value='' readonly = 'readonly'></div><div><h4>Geometrie</h4><textarea class='span12' id='ch_geo_wkt' name='ch_geo_wkt' rows='6' readonly = 'readonly'></textarea></div><center><button type='submit' class='btn btn-primary'>Enregistrer</button></center><input type='hidden' name='MM_insert' value='ajout_feature'></form>";
			document.getElementById("info").innerHTML = formulaire;
			document.getElementById("ch_geo_wkt").innerHTML = out;
