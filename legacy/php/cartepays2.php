...
var vectors1 = new OpenLayers.Layer.Vector(" Pays", {
  ...
  // Fonction creation drapeaux-pays. 
			...
			<?php
			$Nompays = $row_MarkerVilles['ch_pay_nom'];

?>
		var x = '<?php echo e($x); ?>' ;
		var y = '<?php echo e($y); ?>' ;
		var urlicon ='<?= e($row_MarkerVilles['ch_pay_lien_imgdrapeau']) ?>'
                features.push(new OpenLayers.Feature.Vector(
                    new OpenLayers.Geometry.Point(x,y), features.attributes = {
                name: "<?php echo $Nompays; ?>",
				flag: "<?= e($row_MarkerVilles['ch_pay_lien_imgdrapeau']) ?>"
            }));
            return features;
        }
