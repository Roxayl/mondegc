...
<h3 id="myModalLabel">Enlever <?= e($row_fai['ch_his_nom']) ?> de la cat&eacute;gorie <?= e($row_fai['ch_fai_cat_nom']) ?> </h3>
          </div>
          <div class="modal-body">
          <div class="row-fluid">
          <div class="span9">
          <h1>Attention&nbsp;!</h1>
    <p>Souhaitez-vous r&eacute;ellement enlever <?= e($row_fai['ch_his_nom']) ?> de cette cat&eacute;gorie&nbsp;?</p>
    ...
    <div class="span3 icone-categorie"> 
          <img src="<?= e($row_fai['ch_fai_cat_icon']) ?>" alt="icone cat&eacute;gorie" style="background-color:<?= e($row_fai['ch_fai_cat_couleur']) ?>;">
...
<form action="disp_fait_hist_supprimer.php" name="supprimer-categorie" method="POST" id="supprimer-categorie">
            <input name="ch_disp_FH_id" type="hidden" value="<?= e($row_fai['ch_disp_FH_id']) ?>">
            <input name="ch_disp_fait_hist_cat_id" type="hidden" value="<?= e($row_fai['ch_disp_fait_hist_cat_id']) ?>">
