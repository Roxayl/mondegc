...
$query_ville = sprintf("SELECT ch_vil_ID, ch_vil_nom, ch_pay_id, ch_pay_nom FROM temperance INNER JOIN villes ON ch_temp_element_id = ch_vil_ID INNER JOIN pays ON ch_vil_paysID = ch_pay_id WHERE ch_temp_id=%s", escape_sql( $ch_temp_id, "int"));
...
<h4>Nombre de juges votants&nbsp;: <?php echo $totalRows_temperance ?></h4></div>
  ...
  <ul class="listes">
    ...
    <li class="row-fluid">
      <div class="span11">
        <p><strong>3-</strong> Am�nagements permettant un lien entre la ville et son pays (exemple : r�seaux de transports, trac�s des routes etc.)</p>
      </div>
      <div class="span1">
    ...
    <li class="row-fluid">
      <div class="span11">
        <p><strong>4-</strong> Chiffre indiqu� pour la population de la ville</p>
      </div>
      <div class="span1">
    ...
    <li class="row-fluid">
      <div class="span11">
        <p><strong>9- </strong>Activit�s de la ville (source de mises &agrave; jour qualitatives)</p>
      </div>
      <div class="span1">
