...
//=====Envoi de l'e-mail.
    $success = mail($mail, $sujet, $message, $header);
    mail('contact@roxayl.fr', $sujet, $message, $header);
    if(! $success) {
        getErrorMessage('error', "Une erreur s'est produite lors de l'envoi du mail.");
    }
//==========
...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Roboto:400,400i,500,500i,700,700i|Titillium+Web:400,600&subset=latin-ext"
          rel="stylesheet">
    ...
    <div class="row-fluid">
        <div class="span8">
            ...
            <section id="info-generales" class="well">
                <form action="<?= e($editFormAction) ?>" name="new_user" method="POST" class="form-horizontal"
                      id="InfoHeader">
                    ...
                    <div id="spryradio1">
                        <label class="radio" for="ch_use_prov_statut_2">
                            ...
                            Membre <a href="#" rel="clickover" title="Membre"
                                      data-content="Un compte de base. Généralement vous choisirez cette option lors de la création d'un compte."><i
                                        class="icon-info-sign"></i></a></label>
                        <br>
                        <label class="radio" for="ch_use_statut_5">
                            <input name="ch_use_prov_statut" type="radio" id="ch_use_statut_5" value="15">
                            Juge Temp&eacute;rant <a href="#" rel="clickover" title="Juge Temp&eacute;rant"
                                                     data-content="Le juge temp&eacute;rant op&egrave;re dans le cadre du projet Temp&eacute;rance en lien avec l'institut d'&eacute;conomie."><i
                                        class="icon-info-sign"></i></a></label>
                        <br>
                        ...
                        <label class="radio" for="ch_use_prov_statut_3">
                            ...
                            Membre du Haut-Conseil <a href="#" rel="clickover" title="Haut-Conseil"
                                                      data-content="Le membre du Haut-Conseil aura acc&egrave;s aux outils de mod&eacute;ration du Monde GC. Il pourra &eacute;galement alimenter les bases de donn&eacute;es au nom des comités."><i
                                        class="icon-info-sign"></i></a></label>
                        <br>
                        <label class="radio" for="ch_use_prov_statut_4">
                            <input type="radio" name="ch_use_prov_statut" value="30" id="ch_use_statut_3">
                            Administrateur <a href="#" rel="clickover" title="Haut-Conseil"
                                              data-content="L'administrateur a la possibilit&eacute; d'effacer les donn&eacute;es et peut attribuer des statuts sup&eacute;rieurs &agrave; celui des dirigeants."><i
                                        class="icon-info-sign"></i></a></label>
                        <br>
                    ...
                    <div class="alert alert-danger">
                        ...
                        <p>Cr&eacute;ez d'abord un nouveau pays avant de l'assigner au profil d'un nouveau dirigeant. Un
                            maire doit &ecirc;tre obligatoirement rattach&eacute; &agrave; un pays.</p>
                    </div>
                  ...
                  ================================================== -->
                    ...
                    <div id="sprytextfield3" class="control-group">
                        <label class="control-label" for="ch_use_prov_login">Login<a href="#" rel="clickover"
                                                                                     title="Nom du pays"
                                                                                     data-content="12 caract&egrave;res maximum. Ce nom doit être rigoureusement le même que sur le forum de génération city afin de pouvoir lui envoyer des mp. Ce champ est obligatoire"><i
                                        class="icon-info-sign"></i></a></label>
                        <div class="controls">
                            <input class="input-xlarge" type="text" id="ch_use_prov_login" name="ch_use_prov_login"
                                   maxlength="12" value="">
                            <span class="textfieldRequiredMsg">un login est obligatoire.</span> <span
                                    class="textfieldMinCharsMsg">min 2 caract&egrave;res.</span><span
                                    class="textfieldMaxCharsMsg">12 caract&egrave;res max.</span></div>
                    </div>
                    <!-- Adresse mail -->
                    <div id="sprytextfield7" class="control-group">
                        <label class="control-label" for="ch_use_prov_mail">Adresse mail<a href="#" rel="clickover"
                                                                                           title="E-mail"
                                                                                           data-content="Entrez l'adresse sur laquelle seront envoy&eacute;s le login et la clef d'activation pour confirmer l'inscription. Ce champ est obligatoire."><i
                                        class="icon-info-sign"></i></a></label>
                        <div class="controls">
                            <input class="input-xlarge" name="ch_use_prov_mail" type="text" id="ch_use_prov_mail"
                                   value="" maxlength="50">
                            <span class="textfieldInvalidFormatMsg">Format non valide.</span><span
                                    class="textfieldRequiredMsg">Une valeur est requise.</span></div>
                    </div>
                    <input class="input-xlarge" type="hidden" name="ch_use_prov_clef" id="ch_use_prov_clef"
                           value="<?php echo $code_aleatoire; ?>">
                    <br>
                    <!-- Bouton envoyer
                  ================================================== -->
                    <p>&nbsp;</p>
                    <div class="alert alert-tips">
                        <button type="button" class="close" data-dismiss="alert">×</button>
                        <p>Le pseudo doit &ecirc;tre identique &agrave; celui du forum. Le nouveau membre doit ensuite
                            activer son compte en utilisant les informations qui lui ont &eacute;t&eacute; envoy&eacute;es
                            par mail. </p>
                    </div>
                    <div class="control-group">
                        <div class="controls">
        ...
        <div class="span4 pull-center">
            <p>&nbsp;</p>
            <img id="portrait" src="../assets/img/imagesdefaut/personnage.jpg" alt="Personnage" width="250" height="250"
                 title="Personnage"></div>
    </div>
</div>
<!-- Footer
    ================================================== -->
