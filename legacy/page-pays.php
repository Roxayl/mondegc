 ...
 ================================================== -->
          ...
          <div class="well">
            <?php do { ?>
              ...
              <?php } elseif ($row_liste_jeux['ch_vil_type_jeu'] =='SC3'){ ?>
              <img src="assets/img/jeux-ico/sc3.png" class="img-jeu">
              <?php } elseif ($row_liste_jeux['ch_vil_type_jeu'] =='TAP'){ ?>
              <img src="assets/img/jeux-ico/tap.png" class="img-jeu">
              <?php } elseif ($row_liste_jeux['ch_vil_type_jeu'] =='MFT'){ ?>
          ...
          <div id="economie-infrastructures" class="accordion-body collapse">
            ...
            foreach($eloquentPays->infrastructures as $infrastructure):
                ...
                $infraData = array(
                  ...
                  'type' => 'infra',
                  'overlay_image' => $infrastructure->infrastructureOfficielle->ch_inf_off_icone,
                  'overlay_text' => $infrastructure->infrastructureOfficielle->ch_inf_off_nom,
